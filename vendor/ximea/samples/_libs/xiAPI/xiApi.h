...
typedef enum
{
	...
	XI_CNT_SEL_FRAME_MISSED_TRIGGER_DUETO_OVERLAP=3, // Number of missed triggers due to overlap. (see Note1)
...
* @param[out] first_pixel First byte of first pixel of image to be processed
*/
