...
#define  XI_PRM_DP_UNIT_SELECTOR                "dp_unit_selector"        // Data Pipe Unit Selector. XI_DP_PROC_UNIT_SELECTOR
...
typedef enum
{
	...
	XI_RAW32FLOAT                =16, // 32 bits per pixel raw data from sensor in single-precision floating point format
...
typedef enum
{
	...
	XI_TRANSPORT_DATA_TARGET_UNIFIED=2, // Selects unified memory as target for delivered data from the camera.
	XI_TRANSPORT_DATA_TARGET_ZEROCOPY=3, // Selects zerocopy memory as target for delivered data from the camera.
...
typedef enum
{
	...
	XI_TS_RST_SRC_GPI_5          =24, // TimeStamp reset source selected GPI5 (after de bounce)
	XI_TS_RST_SRC_GPI_6          =25, // TimeStamp reset source selected GPI6 (after de bounce)
	XI_TS_RST_SRC_GPI_5_INV      =26, // TimeStamp reset source selected GPI5 inverted (after de bounce)
	XI_TS_RST_SRC_GPI_6_INV      =27, // TimeStamp reset source selected GPI6 inverted (after de bounce)
...
typedef enum
{
	XI_DP_PROC_UNIT_SENSOR       =0, // Selects device image sensor
	XI_DP_PROC_UNIT_FPGA         =1, // Selects device image FPGA
...
typedef enum
{
	XI_DP_PROC_CHANNEL_SOURCE_SELECTOR=0, // Data Source Selector (selected input channel is transferred to output)
	XI_DP_PROC_CHANNEL_MERGER    =1, // Data processor for merging low and high channels from sCMOS sensors
...
typedef enum
{
	XI_DP_PARAM_CHANNEL_MERGER_ALPHA=0, // Channel merger coefficient Alpha
	XI_DP_PARAM_CHANNEL_MERGER_BETA=1, // Channel merger coefficient Beta
	XI_DP_PARAM_CHANNEL_SOURCE   =2, // Channel source
	XI_DP_PARAM_PROC_ENABLE      =3, // Selected data pipe processor is enabled. Apply to all processors.
...
typedef enum
{
	XI_DP_PARAM_CHANNEL_SOURCE_L =0, // Selected source channel LowGain
	XI_DP_PARAM_CHANNEL_SOURCE_H =1, // Selected source channel HighGain
	XI_DP_PARAM_CHANNEL_SOURCE_LH=2, // Selected source channel both gains
	XI_DP_PARAM_CHANNEL_SOURCE_MERGED=3, // Selected source channel weighted sum of both gains (depending on Merger)
